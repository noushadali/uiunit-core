...
public class TasksScheduledVsOutstandingVsCompletedForSalesCoordinator extends WorkSpaceOrganizer{
	
	@Test
	@UIUnitTimeout(1000000)
	public void createTasksScheduledVsOutstandingVsCompletedForSalesCoordinatorGraph() throws Exception
	{
		String bmName = "TasksScheduledVsOutstandingVsCompletedForSalesCoordinatorBM";
		...
		try
		{
			...
			bmWizard.setDescriptionText("TasksScheduledVsOutstandingVsCompletedForSalesCoordinatorBM");
			...
			String selectClause = "count(AssignSalesRepStatus) TotalTasks,AssignSalesRepStatus";
			bmWizard.setSelectClause(selectClause);
			String groupClause = "AssignSalesRepStatus";
		...
		try{
			...
			bmView.selectXAxisField("AssignSalesRepStatus",1);
