...
public class OrdersByPeriodBusinessMeasure extends WorkSpaceOrganizer{
	
	@Test
	@UIUnitTimeout(1000000)
	public void createOrdersByPeriodBusinessMeasure() throws Exception
	{
		String bmName = "OrdersByPeriodBusinessMeasure";
		...
		try
		{
			...
			String selectClause = "Count(OrderID) TotalOrders,month(OrderDate) Month";
		...
		try{
			...
			bmView.selectYAxisField("TotalOrders", true);
