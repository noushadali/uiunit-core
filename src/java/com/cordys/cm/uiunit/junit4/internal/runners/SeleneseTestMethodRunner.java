 ...
 * @author ppostma
 */
public class SeleneseTestMethodRunner extends MethodRoadie implements
																												IRunningTest
{
	 ...
	 * @param description
	 */
	public SeleneseTestMethodRunner(Object test,
																TestMethod method,
	...
	private void runWithTimeout(long timeout)
	{
		...
		environment.getTestRunner().registerTest(this);
...
//			}
		...
		finally
		{
			...
			environment.getTestRunner().unregisterTest(this);
