...
/**
 * UIUnit Annotation. Used to set a startURL for the environment.
 * 
 * @author ppostma
 */
...
public @interface UIUnit
{
	...
	/**
	 * Attribute with the url to start Cordys
	 * 
	 * @return the method name as string
	 */
	String startUrl() default "";

	//TestExecution testExecution() default TestExecution.REUSEBROWSER;
}
